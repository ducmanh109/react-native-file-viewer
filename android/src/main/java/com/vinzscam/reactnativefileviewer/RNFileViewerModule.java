...
public class RNFileViewerModule extends ReactContextBaseJavaModule {
    ...
    private static final String NO_APP_ASSOCIATED = "NO_APP_ASSOCIATED";
    private static final String CANNOT_DETECT_MIME_TYPE = "CANNOT_DETECT_MIME_TYPE";
    ...
    public void open(String path, Integer currentId, ReadableMap options) {
        ...
        if (shareIntent.resolveActivity(pm) != null) {
            ...
            try {
                if (showStoreSuggestions && mimeType == null) {
                    throw new Exception(CANNOT_DETECT_MIME_TYPE);
                }
                throw new Exception(NO_APP_ASSOCIATED);
            } catch (Exception e) {
                sendEvent(OPEN_EVENT, currentId, e.getMessage());
            }
        }
